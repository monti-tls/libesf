...
#define LESF_CORE_PREPROCESSOR_EVAL(...) LESF_CORE_PREPROCESSOR_EVAL512(__VA_ARGS__)
...
#define LESF_CORE_PREPROCESSOR2_EVAL(...) LESF_CORE_PREPROCESSOR2_EVAL512(__VA_ARGS__)
